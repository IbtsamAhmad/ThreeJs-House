...
const moonColorTexture = textureLoader.load('/textures/door/moon.jpg')
/**
 * House
 */
// House container
...
const moonMaterial = new THREE.MeshStandardMaterial({color:'#ffffff'});
const moon = new THREE.Mesh( moonGeometry, moonMaterial );
moon.position.y = 5
moon.position.x = -4
scene.add(moon);

const myMoonLight = new THREE.PointLight('#ffffff', 4, 5,)
myMoonLight.position.set(-3, 8, 2.7)
house.add(myMoonLight)
